            ...
            <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav mr-auto">
                        ...
                        <li class="nav-item <?php if ($_SERVER['REQUEST_URI'] === '/personal-account.php') : ?> active
                        <?php endif; ?>">
                            <a class="nav-link"
                               href="<?php if ($_SERVER['REQUEST_URI'] !== '/personal-account.php') : ?> /personal-account.php
                       <?php else: ?>#<?php endif; ?>">Личный кабинет</a>
                        </li>
